  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className='w-[600px] wx-6 h-8 ml-8'>
          <img 
          ...
          <input
            type="file"
            className="mt-4 w-[250px] py-2 px-4 border bg-blue-500 rounded"
            accept="image/*"
            onChange={(e) => console.log(e.target.files[0])}
          />
         <button className='ml-8 sm:min-w-48 py-2 border bg-green-500 rounded text-black-500'>Join now</button>
        </div>
      </div>
    </div>
  )
